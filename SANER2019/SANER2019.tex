...
\begin{table}[htbp]
	...
	\resizebox{3.5in}{!}{%
		\begin{tabular}{c|c|c|c|c|c|c}
			...
			%			63.06 & 0.36 &
			%			0.34    \\ \hline \hline
			\multirow{2}{*}{3855}                                                                               & Basic VSM & 24.98\% & 47.94\% & 58.73\% & 0.35 & 0.33 \\  \cline{2-7}   &VSM + Association     & 28.43\%                                                 & 53.86\%                                                 & 64.05\%                                                  &   0.39  &  0.37    \\ 
			\hline
	\end{tabular}}
	\centering
\end{table}
...
\begin{table}[htbp]
	...
	\resizebox{3.4in}{!}{%
		\begin{tabular}{c|c|c|c|c|c|c}
			\hline
			%\begin{tabular}[c]{@{}c@{}}\#Bugs for \\ developing \\ map databases\end{tabular} &
			\begin{tabular}[c]{@{}c@{}}\#\textbf{Bugs}  \\ \end{tabular} & \begin{tabular}[c]{@{}c@{}}\textbf{Methodology} \\ \end{tabular} &
			%\textbf{alpha} &
			%\textbf{beta}&
			%\textbf{gamma}& 
...
To answer RQ4, we compare the performance of BLuAMIR with two state-of-the-art techniques - LSI \cite{MarcusLSI} and BugLocator \cite{Jian} for the the same dataset (i.e., SWT and Zxing depicted in Table \ref{tab:performance3}). We replicated the LSI technique for bug localization, which is proposed by \citet{MarcusLSI} for traceability links. For Buglocator \cite{Jian}, we copied the results directly from their paper. We also collect the same bug reports and the same source code repository for both of them. So the results can be compared. 
	...
	\resizebox{3.5in}{!}{%
		\begin{tabular}{c|c|c|c|c|c|c}
			...
			& BLUiR & 30.96  & 53.20 & 62.86  & 0.42 & 0.32 \\  \cline{2-7}
			 &BLuAMIR                                                                     & 22.57                                               & 51.86                                              & 61.37                                            &   0.35  &   0.34  \\ \hline \hline
			\multirow{4}{*}{AspectJ}                                       
			& LSI &  &  &  &  &  \\  \cline{2-7} 
			
			& BugLocator & 22.73 & 40.91 & 55.59 & 0.33 & 0.17 \\  \cline{2-7} 
			& BLUiR & 32.17 & 51.05 & 60.49 & 0.43 & 0.25 \\  \cline{2-7}
			 &BLuAMIR                                                                     & 27.87                                               & 52.46                                              & 63.52                                             &   0.38  &   0.36  \\ \hline \hline
			\multirow{4}{*}{SWT}                                       
			 & LSI & 13.26 & 30.61 & 53.06 & 0.15 & 0.14 \\  \cline{2-7} 
			                                 
			       & BugLocator & 31.63 & 65.31 & 77.55 & 0.47 & 0.40 \\  \cline{2-7} 
			       & BLUiR & 55.10 & 76.53 & 87.76 & 0.65  & 0.56 \\  \cline{2-7} &BLuAMIR                                                                     & 44.90                                               & 73.45                                              & 80.61                                             &   0.57  &   0.54  \\ \hline \hline
			\multirow{4}{*}{Zxing}                  
			
			
			 & LSI & 15.00& 35.00 & 45.00 & 0.23 & 0.23 \\  \cline{2-7}                                               & BugLocator & 40.00 & 55.00 & 70.00 & 0.48 & 0.41 \\  \cline{2-7}  
			 & BLUiR & 40.00 & 65.00 & 70.00 & 0.49  & 0.38 \\  \cline{2-7}
			  &BLuAMIR                                                                  & 30.00                                            & 70.00                                           & 75.00                                             &   0.48  &  0.46   \\ \hline
