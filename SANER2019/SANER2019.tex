...
First, we evaluate in terms of the performance metrics, and contrast with two replicated baseline, Vector Space Model(VSM) and BugLocator \cite{Jian}.
...
\begin{itemize}
	...
	two existing approaches including the state-of-the-art \cite{Jian} and LSI-based bug localization technique \cite{MarcusLSI}.
\end{itemize}
