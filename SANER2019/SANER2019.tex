...
%While VSM-based approaches fail to retrieve such ground truth  
%Even if there is no vocabulary overlap between query and the candidate document, 
%Even if the query and recommended buggy files do not share same keyword but previously shared same concept can aid locating that query. 
