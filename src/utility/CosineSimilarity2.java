...
public class CosineSimilarity2
{
     ...
     public double Cosine_Similarity_Score(String Text1, String Text2)
     {
          ...
          Hashtable<String, values> word_freq_vector = new Hashtable<String, CosineSimilarity2.values>();
     ...
     public static void main(String[] args)
     {
         ...
         // System.out.println("[Word # VectorA # VectorB]");
          double sim_score = cs1.Cosine_Similarity_Score("Masud love me", "Masud love I");
