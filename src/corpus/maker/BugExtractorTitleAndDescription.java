...
public class BugExtractorTitleAndDescription {

	String xmlFileName;
	String outDir;

	public BugExtractorTitleAndDescription(String xmlFileName, int year) {
		this.xmlFileName = StaticData.BUGDIR + "/" + xmlFileName;
		this.outDir = StaticData.BUGDIR + "/BugReportsTitleAndDescription/"+ year;
	}
	
	public BugExtractorTitleAndDescription(String xmlFileName) {
		this.xmlFileName = "E:\\PhD\\Repo\\Zxing\\BugXML\\" + xmlFileName;
		this.outDir = "E:\\PhD\\Repo\\Zxing\\BugDataExtracted\\";
	}
	...
	public static void main(String[] args) {
		...
		/*
		String xmlFileName="show_bug_plat_UI_Closed_fixed_44_1stJan2001_to_31stDec2001.xml";
		int year=2001;
		new BugExtractorTitleAndDescription(xmlFileName, year).extractBugReports();
		//This is a simple change to the fine.*/
		
		
		String XMLfolderPath="E:\\PhD\\Repo\\Zxing\\bugXML\\";
		...
		for (File file : files) {
	        if (file.isDirectory()) {
	            ...
	            new BugExtractorTitleAndDescription(file.getName()).extractBugReports();
	        }
	    }
