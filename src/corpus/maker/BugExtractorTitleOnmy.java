...
public class BugExtractorTitleOnmy {

	String xmlFileName;
	String outDir;

	public BugExtractorTitleOnmy(String xmlFileName, int year) {
		this.xmlFileName = StaticData.BUGDIR + "/" + xmlFileName;
		this.outDir = StaticData.BUGDIR + "/BugReportsTitleOnly/"+ year;
	}
	...
	public static void main(String[] args) {
		...
		int year=2015;
		new BugExtractorTitleOnmy(xmlFileName, year).extractBugReports();
