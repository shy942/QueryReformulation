    ...
    public class PerformanceCalculatorForBLUiR {
        ...
        public PerformanceCalculatorForBLUiR(String gitPath, String resultPath)
        {
        ...
        public PerformanceCalculatorForBLUiR() {
        ...
        public static void main(String[] args) {
           ...
           // new PerformanceCalculatorPerfect().checkResultSizeAndContent(3071, "E:\\PhD\\Repo\\Eclipse", "VSMandMe", 0.4);
            new PerformanceCalculatorForBLUiR().getAvgPerformance("results.txt");
            //new PerformanceCalculatorPerfect().getAvgPerformance(1, 0, "VSMandMe");
        }

        public static void checkResultSizeAndContent(int no_of_fold, String base, String baseNamePart, double alpha)
        {
            for(int i=2;i<=no_of_fold;i++)
            {
                int test=i;
                String resultFilePath=base+"\\data\\Results/"+"/Feb08"+baseNamePart+alpha+"-"+test+".txt";
                //if(new File(resultFilePath).length()<=10000)
                    System.out.println(test+" "+new File(resultFilePath).length());
            }
        }
        ...
        public static void getAvgPerformance(String baseNamePart)
        {
            ...
            PerformanceCalculatorForBLUiR obj=new PerformanceCalculatorForBLUiR();
            
            //String method="VSM";
            
            String corpus="Apache/CAMEL";
            String method="BLUiR";
            String version="1_6_0";
            String base= "E:\\PhD\\Repo\\"+corpus+"/"+version+"/";
            ...
            ArrayList<String> listAllTestBugs=ContentLoader.getAllLinesOptList(alltestBugs);
                ...
                if(resultFilePath.length()<=0)System.out.println(resultFilePath.length());
                 ...
                 obj=new PerformanceCalculatorForBLUiR(base+"\\data\\gitinfo"+"CAMEL"+".txt",resultFilePath);      
        ...
        public static HashMap<String, Double> getResultForTopK(PerformanceCalculatorForBLUiR obj)
        {
        ...
        public static double ComputeMAP(HashMap<String, ArrayList<String>> finalRankedResult, PerformanceCalculatorForBLUiR obj)
        {
        ...
        public static double getAvgPrecisionEachQuery(ArrayList<String> rankList, String queryID, PerformanceCalculatorForBLUiR obj)
        {
        ...
        public static double ComputeMRR(HashMap<String, ArrayList<String>> finalRankedResult, PerformanceCalculatorForBLUiR obj, int TOP_K)
        {
        ...
        private static HashMap<String, ArrayList<String>> ComputePerformancePercent(int TOP_K, PerformanceCalculatorForBLUiR obj) {
            // TODO Auto-generated method stub
