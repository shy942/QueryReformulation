...
public class CalculateLocalizationPerformanceQR {
	...
	public CalculateLocalizationPerformanceQR(HashMap<String, ArrayList<String>> retTrueSetResults, HashMap<String, ArrayList<String>> retActualResultSets)
	{
		this.ActualResultSets=retActualResultSets;
		this.TrueSetResults=retTrueSetResults; 
	}
	
	public CalculateLocalizationPerformanceQR(HashMap<String, ArrayList<String>> retTrueSetResults)
	{
		this.TrueSetResults=retTrueSetResults;
	}
	...
	public static void main(String[] args) {
		...
		CalculateLocalizationPerformanceQR obj=new CalculateLocalizationPerformanceQR(TrueSetResults,ActualResultSets);		
